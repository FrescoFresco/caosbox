...
class _InfoModalState extends State<InfoModal> {
  ...
  @override void dispose() {
    _d1?.cancel(); _d2?.cancel();
    ed.dispose(); note.dispose();
    super.dispose();
  }
  ...
  @override Widget build(BuildContext ctx) {
    return AnimatedBuilder(
      ...
      builder: (_, __) {
        final it = widget.state.getItem(widget.id)!;
        final linked = widget.state.all
              ...
              child: Column(children: [
                Padding(
                  ...
                  child: Row(children: [
                    ...
                    Expanded(child: Text(it.id, style: Style.title)),
                    IconButton(
