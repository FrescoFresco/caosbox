...
class _GenericScreenState extends State<GenericScreen> with AutomaticKeepAliveClientMixin {
  ...
  @override Widget build(BuildContext ctx) {
    super.build(ctx);
    final t = widget.block.type!, cfg = widget.block.cfg!;
    ...
    return Padding(padding: const EdgeInsets.all(12), child: Column(children: [
      ComposerCard(icon: cfg.icon, hint: cfg.hint, c: _c,
      ...
      Expanded(child: ListView.builder(
        ...
        itemBuilder: (_, i) {
          ...
          return ItemCard(item: it, st: widget.state, ex: open,
            onT: () { open ? _ex.remove(it.id) : _ex.add(it.id); _r(); },
